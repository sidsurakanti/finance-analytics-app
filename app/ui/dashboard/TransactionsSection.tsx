...
export default function TransactionSection({
  ...
  const recentTotal = transactions.reduce((a, b) => a + Number(b.amount), 0).toFixed(2)

  return (
    <section
      className="w-4/5 h-fit p-5 space-y-7 bg-[#121212] outline outline-[#444444] rounded-lg"
    >
