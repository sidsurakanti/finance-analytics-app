...
import { fetchCashflows, fetchTransactions, fetchTransactionsThisMonth, fetchUser } from "@/app/lib/data";
...
export default async function Dashboard() {
  ...
  const thisMonthTotal = thisMonthsTransactions.reduce((a, b) => a + Number(b.amount), 0).toFixed(2)
